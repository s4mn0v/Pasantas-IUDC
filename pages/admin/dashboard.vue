              ...
              <tr class="bg-white transition-all duration-500 hover:bg-gray-50">
                ...
                <td class="p-5">
                  <div class="flex items-center gap-1">
                    ...
                    >
                      <Icon name="uil:edit" class="w-5 h-5 text-indigo-500" />
                    </button>
                    <button
                      class="p-2 rounded-full group transition-all duration-500 flex items-center"
                    >
                      <Icon name="uil:trash-alt" class="w-5 h-5 text-red-600" />
                    </button>
                    <button
                      class="p-2 rounded-full group transition-all duration-500 flex items-center"
                    >
                      <Icon name="uil:draggabledots" class="w-5 h-5 text-black" />
                    </button>
                  </div>
                </td>
              </tr>
              <!-- Repite el bloque <tr> para cada fila adicional de la tabla -->
            </tbody>
          </table>
        </div>
      </div>
